...
/**
 * TamaGame est la classe chargée de l'ééxécution et la gestion du jeu des tamagoshis <br>
 * Celle-ci va permettre d'initialiser les tamagoshis, de gérer un cycle, afficher les résultats...
 */
